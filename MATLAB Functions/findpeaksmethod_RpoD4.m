...
CL = []; % cell length at peak
    ...
    for k = 1:size(T,2)
        ...
        %[pks locs w p] = findpeaks(ypol,t,'MinPeakProminence',40);
        %[pks0 idx0] = findpeaks(ypol,'MinPeakProminence',40);
        [pks locs w p] = findpeaks(y,t,'MinPeakProminence',40);
        [pks0 idx0] = findpeaks(y,'MinPeakProminence',40);  
